...
graph TB
    ...
    classDef nodeStyle fill:#f9f,stroke:#333,stroke-width:2px,rounded:false
    classDef subModuleStyle fill:#ccf,stroke:#333,stroke-width:2px,rounded:false
    classDef moduleStyle fill:#ffc,stroke:#333,stroke-width:2px,rounded:false
    
    class 博客网站 nodeStyle
    class 用户模块,文章模块,评论模块,说说模块,资源模块 moduleStyle
    class 账号管理,个人信息管理,浏览文章 subModuleStyle
```
...
graph TB
    ...
    class 管理后台 nodeStyle
    class 用户管理模块,文章管理模块,评论管理模块,分类标签管理模块,资源管理模块,系统配置模块 moduleStyle
```
