...
graph TD
    ...
    class A,B1,B2,B3,B4,B5,C11,C12,C13,C14,C15,C16,C17,C21,C22,C23,C24,C25,C26,C31,C32,C33,C41,C42,C43,C51,C52 rectStyle
```
...
graph TD
    ...
    class A,B1,B2,B3,B4,B5,B6,C11,C12,C13,C14,C21,C22,C23,C24,C31,C32,C33,C41,C42,C43,C44,C51,C52,C61,C62,C63,C64,C65 rectStyle
```
