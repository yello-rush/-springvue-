...
INSERT INTO `article_stat_daily` VALUES (1,292,'2026-03-19',50,500),(2,292,'2026-03-17',70,700),(3,292,'2026-03-09',280,2800),(4,296,'2026-03-19',30,1000),(5,296,'2026-03-17',60,2000),(6,296,'2026-03-09',260,3000),(7,297,'2026-03-19',80,100),(8,297,'2026-03-17',120,200),(9,297,'2026-03-09',300,300);
...
INSERT INTO `sys_album` VALUES (6,'测试相册','本地图库测试','http://127.0.0.1:8800/localFile/test-image-1.jpg',0,NULL,NULL,NULL),(7,'测试相册','本地图库测试','http://127.0.0.1:8800/localFile/test-image-1.jpg',0,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=307 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='博客文章表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_article` VALUES (292,1,20,'个人开发的管理系统  Neat-Admin','https://picsum.photos/seed/neat-admin/800/400','基于vue3+typescript+elmentui-plus开发的一款后台管理系统，功能跟若依差不多，主要不同的是样式美化，要比若依更漂亮','<h4><a id=\"_0\"></a>前言</h4>\r\n<p>本后台管理系统基于当下前沿的技术栈 vue3、typescript 以及 elementui-plus 进行精心构建。在功能维度上，其与若依系统具备相当的完整性与丰富度，涵盖了诸如用户管理、权限控制、数据统计分析、业务流程处理等一系列核心后台管理功能模块，能够高效地支撑各类企业级业务运营需求。然而，本系统在视觉呈现方面展现出独特的优势，通过对样式的深度美化与精心雕琢，采用了更为先进的 UI 设计理念与精细化的布局策略，运用精致的色彩搭配、优雅的字体选择以及灵动的交互元素设计，使其整体视觉效果相较于若依更为美观、精致且专业，能够为用户带来更舒适、高效且具品质感的操作体验，极大地提升了后台管理工作的愉悦度与便捷性，彰显出卓越的专业性与高端品质形象。</p>\r\n<h4><a id=\"_4\"></a>视频预览</h4>\r\n<p><video height=\"100%\" width=\"100%\" src=\"http://127.0.0.1:8800/localFile/local-plus/upload/20241120_230652.mp4\" controls autoplay></video></p>\r\n<h4><a id=\"_8\"></a>仓库地址</h4>\r\n<p><a href=\"https://gitee.com/quequnlong/vue-neat-admin\" target=\"_blank\">Neat-Admin</a></p>\r\n','#### 前言\r\n\r\n  本后台管理系统基于当下前沿的技术栈 vue3、typescript 以及 elementui-plus 进行精心构建。在功能维度上，其与若依系统具备相当的完整性与丰富度，涵盖了诸如用户管理、权限控制、数据统计分析、业务流程处理等一系列核心后台管理功能模块，能够高效地支撑各类企业级业务运营需求。然而，本系统在视觉呈现方面展现出独特的优势，通过对样式的深度美化与精心雕琢，采用了更为先进的 UI 设计理念与精细化的布局策略，运用精致的色彩搭配、优雅的字体选择以及灵动的交互元素设计，使其整体视觉效果相较于若依更为美观、精致且专业，能够为用户带来更舒适、高效且具品质感的操作体验，极大地提升了后台管理工作的愉悦度与便捷性，彰显出卓越的专业性与高端品质形象。\r\n  \r\n  #### 视频预览\r\n    <video height=100% width=100% src=\"http://127.0.0.1:8800/localFile/local-plus/upload/20241120_230652.mp4\" controls autoplay></video>\r\n  \r\n  \r\n  #### 仓库地址\r\n  [Neat-Admin](https://gitee.com/quequnlong/vue-neat-admin)',1,0,'publish',1,0,895,NULL,NULL,'2026-02-05 15:09:03','2026-03-26 12:33:34',26.3,'2026-03-27 13:38:20','2026-03-29 20:49:58',38),(296,1,17,'深入理解 Java 内存模型 (JMM)','https://picsum.photos/seed/0.917908986223823/800/400','Java内存模型(Java Memory Model)是Java虚拟机规范中定义的一种内存模型，用于屏蔽掉各种硬件和操作系统的内存访问差异...','# Java 内存模型\n\nJava内存模型(Java Memory Model)是Java虚拟机规范中定义的一种内存模型...','# Java 内存模型\n\nJava内存模型(Java Memory Model)是Java虚拟机规范中定义的一种内存模型...',0,0,'publish',1,0,330,NULL,NULL,'2025-05-31 02:03:08','2025-08-15 00:51:15',99999,'2026-03-19 17:44:25','2026-03-19 18:12:58',12),(297,1,17,'Spring Boot 自动配置原理详解','https://picsum.photos/seed/0.6758853606921607/800/400','Spring Boot的自动配置机制是其核心特性之一，本文将带你深入源码，剖析@EnableAutoConfiguration的工作原理...','# Spring Boot 自动配置\n\nSpring Boot的自动配置机制是其核心特性之一...','# Spring Boot 自动配置\n\nSpring Boot的自动配置机制是其核心特性之一...',0,0,'publish',1,0,852,NULL,NULL,'2025-08-11 21:02:57','2025-10-16 00:10:22',0,NULL,NULL,58),(298,1,17,'Java 8 Stream API 实战指南','https://picsum.photos/seed/0.9227929915192403/800/400','Java 8引入的Stream API极大地简化了集合操作，本文通过大量示例讲解Stream的常用方法...','# Java 8 Stream API\n\nJava 8引入的Stream API极大地简化了集合操作...','# Java 8 Stream API\n\nJava 8引入的Stream API极大地简化了集合操作...',0,0,'publish',0,0,269,NULL,NULL,'2025-12-22 18:16:53','2026-02-10 19:25:58',0,NULL,NULL,13),(299,1,31,'Vue 3.0 组合式 API (Composition API) 上手教程','https://picsum.photos/seed/0.16424648985927748/800/400','Vue 3.0带来的组合式API解决了Vue 2.x中逻辑复用困难的问题，本文带你快速上手...','# Vue 3.0 Composition API\n\nVue 3.0带来的组合式API解决了Vue 2.x中逻辑复用困难的问题...','# Vue 3.0 Composition API\n\nVue 3.0带来的组合式API解决了Vue 2.x中逻辑复用困难的问题...',0,0,'publish',0,0,107,NULL,NULL,'2025-10-09 05:10:15','2026-01-01 05:34:45',0,NULL,NULL,5),(300,1,31,'Vue Router 4.x 路由守卫详解','https://picsum.photos/seed/0.45122870323392283/800/400','在Vue项目开发中，路由守卫是控制页面访问权限的重要手段，本文详细介绍Vue Router 4.x的各种守卫...','# Vue Router 4.x 路由守卫\n\n在Vue项目开发中，路由守卫是控制页面访问权限的重要手段...','# Vue Router 4.x 路由守卫\n\n在Vue项目开发中，路由守卫是控制页面访问权限的重要手段...',0,0,'publish',0,0,2574,NULL,NULL,'2025-04-06 08:11:16','2025-05-02 04:49:12',0,NULL,NULL,59),(301,1,28,'MySQL 索引失效的十大场景','https://picsum.photos/seed/0.5590151355500466/800/400','索引是提升MySQL查询性能的关键，但很多时候我们建立的索引并没有生效，本文总结了索引失效的常见场景...','# MySQL 索引失效\n\n索引是提升MySQL查询性能的关键...','# MySQL 索引失效\n\n索引是提升MySQL查询性能的关键...',0,0,'publish',0,0,562,NULL,NULL,'2025-08-01 06:27:21','2025-10-20 01:18:38',0,NULL,NULL,16),(302,1,28,'MySQL 事务隔离级别与锁机制','https://picsum.photos/seed/0.8731188937615777/800/400','深入理解MySQL的事务隔离级别（Read Uncommitted, Read Committed, Repeatable Read, Serializable）以及锁机制...','# MySQL 事务与锁\n\n深入理解MySQL的事务隔离级别...','# MySQL 事务与锁\n\n深入理解MySQL的事务隔离级别...',0,0,'publish',0,0,894,NULL,NULL,'2025-10-09 15:18:31','2025-12-08 03:35:11',0,NULL,NULL,28),(303,1,28,'Redis 持久化机制 RDB 与 AOF 对比','https://picsum.photos/seed/0.38200535687081993/800/400','Redis提供了RDB和AOF两种持久化机制，它们各有优缺点，本文将对比它们的原理和适用场景...','# Redis 持久化\n\nRedis提供了RDB和AOF两种持久化机制...','# Redis 持久化\n\nRedis提供了RDB和AOF两种持久化机制...',0,0,'publish',0,0,1101,NULL,NULL,'2025-11-23 11:00:31','2026-01-19 20:31:59',0,NULL,NULL,75),(304,1,28,'Redis 缓存穿透、缓存击穿与缓存雪崩解决方案','https://picsum.photos/seed/0.4745853874802646/800/400','在高并发场景下，Redis缓存可能会遇到穿透、击穿、雪崩等问题，本文提供详细的解决方案...','# Redis 缓存问题\n\n在高并发场景下，Redis缓存可能会遇到穿透、击穿、雪崩等问题...','# Redis 缓存问题\n\n在高并发场景下，Redis缓存可能会遇到穿透、击穿、雪崩等问题...',0,0,'publish',0,0,892,NULL,NULL,'2025-08-29 12:26:17','2025-11-25 19:59:46',0,NULL,NULL,34),(305,1,16,'Docker 容器化部署 Spring Boot + Vue 项目','https://picsum.photos/seed/0.6376893201575118/800/400','本文详细介绍如何使用Docker和Docker Compose部署前后端分离的Spring Boot + Vue项目...','# Docker 部署\n\n本文详细介绍如何使用Docker和Docker Compose部署...','# Docker 部署\n\n本文详细介绍如何使用Docker和Docker Compose部署...',0,0,'publish',0,0,238,NULL,NULL,'2025-06-02 06:53:31','2025-06-10 05:36:40',0,NULL,NULL,7),(306,1,16,'Linux 常用命令速查手册','https://picsum.photos/seed/0.617986949375332/800/400','整理了Linux运维中常用的命令，包括文件操作、系统监控、网络配置等...','# Linux 常用命令\n\n整理了Linux运维中常用的命令...','# Linux 常用命令\n\n整理了Linux运维中常用的命令...',0,0,'publish',0,0,1916,NULL,NULL,'2025-05-12 11:38:39','2025-06-16 00:21:18',0,NULL,NULL,69);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_article_quantity_update` AFTER UPDATE ON `sys_article` FOR EACH ROW BEGIN
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='鏂囩珷鏀惰棌琛';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章版本历史记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1055 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='文章点赞表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_article_like_insert` AFTER INSERT ON `sys_article_like` FOR EACH ROW BEGIN
    INSERT INTO article_stat_daily (article_id, date, likes_inc, views_inc)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_article_like_delete` AFTER DELETE ON `sys_article_like` FOR EACH ROW BEGIN
    INSERT INTO article_stat_daily (article_id, date, likes_inc, views_inc)
...
CREATE TABLE `sys_article_tag` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1400 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='文章标签关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_article_tag` VALUES (1379,292,1),(1380,292,12),(1386,296,66),(1387,297,66),(1388,297,1),(1389,298,66),(1390,299,100),(1391,300,100),(1392,301,31),(1393,302,31),(1394,303,17),(1395,304,17),(1396,305,101),(1397,305,1),(1398,305,100),(1399,306,18);
...
INSERT INTO `sys_cache` VALUES ('article_quantity','{\"@type\":\"java.util.HashMap\",\"292\":[\"127.0.0.1\"]}',-1),('Authorization:login:session:1','{\"@type\":\"cn.dev33.satoken.session.SaSession\",\"createTime\":1774600221052,\"dataMap\":{\"@type\":\"java.util.HashMap\",\"current_user\":{\"@type\":\"com.mojian.dto.user.LoginUserInfo\",\"avatar\":\"/avatar/blogger.jpg\",\"id\":1,\"nickname\":\"管理员\",\"token\":\"b7250a55-1ec6-4f96-8315-055c33efc752\",\"username\":\"admin\"}},\"id\":\"Authorization:login:session:1\",\"loginId\":1,\"loginType\":\"login\",\"timeout\":604797,\"tokenSignList\":[{\"device\":\"default-device\",\"value\":\"e5556a6b-70d8-486e-a139-e79efe054836\"},{\"device\":\"default-device\",\"value\":\"f1b1bf84-1fdc-4ac0-8ebc-71c4fc47130a\"},{\"device\":\"default-device\",\"value\":\"e1dfaef8-32a4-454d-b175-862aa2de8c2d\"},{\"device\":\"default-device\",\"value\":\"8a6cfeaf-f1b2-48a8-bc7b-c3fe4ad16e8a\"},{\"device\":\"default-device\",\"value\":\"86c5a1e1-bf3a-49ae-a707-c4e609e3fdfa\"},{\"device\":\"default-device\",\"value\":\"1ee618a9-0e6b-4b51-9ee5-253e1973cbef\"},{\"device\":\"default-device\",\"value\":\"a724a36b-6fde-4b7b-88ad-1faf035387bd\"},{\"device\":\"default-device\",\"value\":\"b98d0add-ed76-4c4f-950e-cf012e0bafcb\"},{\"device\":\"default-device\",\"value\":\"c0082c54-71f0-4bfa-8dd0-ebdc5bd2f36f\"},{\"device\":\"default-device\",\"value\":\"2772b93b-27ec-4b64-b700-8d7b86ad7433\"},{\"device\":\"default-device\",\"value\":\"58d688e4-e59f-4685-94fb-61eeed3e8170\"},{\"device\":\"default-device\",\"value\":\"b7250a55-1ec6-4f96-8315-055c33efc752\"}],\"type\":\"Account-Session\"}',1775393479997),('Authorization:login:token:1ee618a9-0e6b-4b51-9ee5-253e1973cbef','\"1\"',1775284220179),('Authorization:login:token:2772b93b-27ec-4b64-b700-8d7b86ad7433','\"1\"',1775364363446),('Authorization:login:token:58d688e4-e59f-4685-94fb-61eeed3e8170','\"1\"',1775366562667),('Authorization:login:token:86c5a1e1-bf3a-49ae-a707-c4e609e3fdfa','\"1\"',1775284077138),('Authorization:login:token:8a6cfeaf-f1b2-48a8-bc7b-c3fe4ad16e8a','\"1\"',1775223689564),('Authorization:login:token:a724a36b-6fde-4b7b-88ad-1faf035387bd','\"1\"',1775284231995),('Authorization:login:token:b7250a55-1ec6-4f96-8315-055c33efc752','\"1\"',1775393482869),('Authorization:login:token:b98d0add-ed76-4c4f-950e-cf012e0bafcb','\"1\"',1775362774537),('Authorization:login:token:c0082c54-71f0-4bfa-8dd0-ebdc5bd2f36f','\"1\"',1775362897294),('Authorization:login:token:e1dfaef8-32a4-454d-b175-862aa2de8c2d','\"1\"',1775223249317),('Authorization:login:token:e5556a6b-70d8-486e-a139-e79efe054836','\"1\"',1775207706990),('Authorization:login:token:f1b1bf84-1fdc-4ac0-8ebc-71c4fc47130a','\"1\"',1775215548994),('blog_views_count','167L',-1),('login:token:1ee618a9-0e6b-4b51-9ee5-253e1973cbef','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"169.254.186.38\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-28 14:30:20\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"1ee618a9-0e6b-4b51-9ee5-253e1973cbef\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775284220217),('login:token:2772b93b-27ec-4b64-b700-8d7b86ad7433','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"127.0.0.1\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-29 12:46:03\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"2772b93b-27ec-4b64-b700-8d7b86ad7433\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775364363452),('login:token:58d688e4-e59f-4685-94fb-61eeed3e8170','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"127.0.0.1\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-29 13:22:42\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"58d688e4-e59f-4685-94fb-61eeed3e8170\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775366562674),('login:token:86c5a1e1-bf3a-49ae-a707-c4e609e3fdfa','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"169.254.186.38\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-28 14:27:57\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"86c5a1e1-bf3a-49ae-a707-c4e609e3fdfa\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775284077349),('login:token:8a6cfeaf-f1b2-48a8-bc7b-c3fe4ad16e8a','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"169.254.186.38\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-27 21:41:29\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"8a6cfeaf-f1b2-48a8-bc7b-c3fe4ad16e8a\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775223689591),('login:token:a724a36b-6fde-4b7b-88ad-1faf035387bd','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"169.254.186.38\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-28 14:30:32\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"a724a36b-6fde-4b7b-88ad-1faf035387bd\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775284232201),('login:token:b7250a55-1ec6-4f96-8315-055c33efc752','\"{\\\"avatar\\\":\\\"/avatar/blogger.jpg\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"127.0.0.1\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-29 20:51:22\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"管理员\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"b7250a55-1ec6-4f96-8315-055c33efc752\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775393482945),('login:token:b98d0add-ed76-4c4f-950e-cf012e0bafcb','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"127.0.0.1\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-29 12:19:34\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"b98d0add-ed76-4c4f-950e-cf012e0bafcb\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775362774627),('login:token:c0082c54-71f0-4bfa-8dd0-ebdc5bd2f36f','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"127.0.0.1\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-29 12:21:37\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"c0082c54-71f0-4bfa-8dd0-ebdc5bd2f36f\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775362897304),('login:token:e1dfaef8-32a4-454d-b175-862aa2de8c2d','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"169.254.186.38\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-27 21:34:09\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"e1dfaef8-32a4-454d-b175-862aa2de8c2d\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775223249367),('login:token:e5556a6b-70d8-486e-a139-e79efe054836','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"169.254.186.38\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-27 17:15:07\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"e5556a6b-70d8-486e-a139-e79efe054836\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775207707076),('login:token:f1b1bf84-1fdc-4ac0-8ebc-71c4fc47130a','\"{\\\"avatar\\\":\\\"https://img2.baidu.com/it/u=3029837478,1144772205&fm=253&app=120&size=w931&n=0&f=JPEG&fmt=auto?sec=1731862800&t=a82c956c5d1b9ded3bcd9ffe204802f5\\\",\\\"browser\\\":\\\"Chrome\\\",\\\"createTime\\\":\\\"2024-12-27 14:16:17\\\",\\\"id\\\":1,\\\"ip\\\":\\\"169.254.186.38\\\",\\\"ipLocation\\\":\\\"内网IP|内网IP\\\",\\\"lastLoginTime\\\":\\\"2026-03-27 19:25:49\\\",\\\"loginType\\\":\\\"email\\\",\\\"mobile\\\":\\\"\\\",\\\"nickname\\\":\\\"墨笺\\\",\\\"os\\\":\\\"Windows\\\",\\\"password\\\":\\\"\\\",\\\"sex\\\":1,\\\"status\\\":1,\\\"tokenValue\\\":\\\"f1b1bf84-1fdc-4ac0-8ebc-71c4fc47130a\\\",\\\"updateTime\\\":\\\"2024-12-30 13:43:25\\\",\\\"username\\\":\\\"admin\\\"}\"',1775215549070),('rate_limit:127.0.0.1/api/message/list','\"2\"',1774788702642),('rate_limit:169.254.186.38/api/message/list','\"1\"',1774679316493),('slider_captcha_code:ddefc02cc1614106aa6e3d935f150deb','\"124\"',1774679435261),('sys_webconfig','\"{\\\"aboutMe\\\":\\\"<p>西伯利亚系统气不气</p>\\\",\\\"author\\\":\\\"习习中\\\",\\\"authorAvatar\\\":\\\"\\\",\\\"authorInfo\\\":\\\"彻底疯狂\\\",\\\"bulletin\\\":\\\"有没有在长沙内推的小伙伴，卑微博主在线求职了，有的话<span style=\\\\\\\"color:red\\\\\\\">VX：1248954763</span> 联系博主\\\",\\\"createTime\\\":\\\"2024-12-22 11:55:25\\\",\\\"email\\\":\\\"1248954763@qq.com\\\",\\\"gitee\\\":\\\"https://gitee.com/quequnlong\\\",\\\"github\\\":\\\"https://github.com/quequnlong\\\",\\\"id\\\":1,\\\"loginTypeList\\\":\\\"[\\\\\\\"gitee\\\\\\\",\\\\\\\"qq\\\\\\\",\\\\\\\"wechat\\\\\\\"]\\\",\\\"logo\\\":\\\"/avatar/blogger.jpg\\\",\\\"name\\\":\\\"习习中博客\\\",\\\"openAdmiration\\\":1,\\\"openComment\\\":1,\\\"openLantern\\\":0,\\\"qqGroup\\\":\\\"779881756\\\",\\\"qqNumber\\\":\\\"1248954763\\\",\\\"showList\\\":\\\"[\\\\\\\"qq\\\\\\\",\\\\\\\"wechat\\\\\\\",\\\\\\\"gitee\\\\\\\",\\\\\\\"qqGroup\\\\\\\",\\\\\\\"github\\\\\\\",\\\\\\\"email\\\\\\\"]\\\",\\\"summary\\\":\\\"一个专注于技术分享的博客平台\\\",\\\"touristAvatar\\\":\\\"\\\",\\\"updateTime\\\":\\\"2024-12-22 11:55:25\\\",\\\"webUrl\\\":\\\"null\\\",\\\"wechat\\\":\\\"1248954763\\\"}\"',-1),('unique_visitor','Set[\"1fc5d450cd6519957bfe9b7c25c2c4e7\",\"5657ae44642764fbf8be97f598a500db\"]',-1),('unique_visitor_count','2L',-1);
...
INSERT INTO `sys_category` VALUES (13,'生活随笔',1,'2024-12-22 12:51:31',NULL),(16,'运维部署',1,'2024-12-22 18:59:28',NULL),(17,'后端开发',1,NULL,NULL),(19,'网络爬虫',NULL,NULL,NULL),(20,'资源软件',NULL,NULL,NULL),(28,'数据库',NULL,NULL,NULL),(31,'前端开发',NULL,NULL,NULL),(32,'博客文档',NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=165 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='评论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_comment` VALUES (32,292,5,NULL,NULL,'Mock comment 1 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-02-08 01:35:37'),(33,292,7,NULL,NULL,'Mock comment 2 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-02-14 05:35:54'),(34,292,6,NULL,NULL,'Mock comment 3 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-02-16 00:11:30'),(35,292,8,NULL,NULL,'Mock comment 4 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-02-23 12:14:58'),(36,292,8,NULL,NULL,'Mock comment 5 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-02-23 20:58:20'),(37,292,18,NULL,NULL,'Mock comment 6 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-03-01 09:21:01'),(38,292,18,NULL,NULL,'Mock comment 7 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-03-06 20:48:39'),(39,292,19,NULL,NULL,'Mock comment 8 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-03-22 08:39:37'),(40,292,20,NULL,NULL,'Mock comment 9 for article 292',0,0,NULL,NULL,NULL,NULL,'2026-03-23 23:06:18'),(41,296,20,NULL,NULL,'Mock comment 1 for article 296',0,0,NULL,NULL,NULL,NULL,'2025-07-05 13:48:50'),(42,296,16,NULL,NULL,'Mock comment 2 for article 296',0,0,NULL,NULL,NULL,NULL,'2025-10-17 05:29:51'),(43,296,17,NULL,NULL,'Mock comment 3 for article 296',0,0,NULL,NULL,NULL,NULL,'2025-12-05 11:03:25'),(44,296,5,NULL,NULL,'Mock comment 4 for article 296',0,0,NULL,NULL,NULL,NULL,'2025-12-17 14:30:29'),(45,296,6,NULL,NULL,'Mock comment 5 for article 296',0,0,NULL,NULL,NULL,NULL,'2025-12-30 23:47:20'),(46,296,14,NULL,NULL,'Mock comment 6 for article 296',0,0,NULL,NULL,NULL,NULL,'2026-01-02 21:36:37'),(47,296,13,NULL,NULL,'Mock comment 7 for article 296',0,0,NULL,NULL,NULL,NULL,'2026-01-31 19:39:22'),(48,296,2,NULL,NULL,'Mock comment 8 for article 296',0,0,NULL,NULL,NULL,NULL,'2026-03-11 05:17:24'),(49,297,14,NULL,NULL,'Mock comment 1 for article 297',0,0,NULL,NULL,NULL,NULL,'2025-08-15 13:45:24'),(50,297,20,NULL,NULL,'Mock comment 2 for article 297',0,0,NULL,NULL,NULL,NULL,'2025-08-21 17:41:04'),(51,297,18,NULL,NULL,'Mock comment 3 for article 297',0,0,NULL,NULL,NULL,NULL,'2025-09-02 09:59:58'),(52,297,16,NULL,NULL,'Mock comment 4 for article 297',0,0,NULL,NULL,NULL,NULL,'2025-09-22 08:29:24'),(53,297,5,NULL,NULL,'Mock comment 5 for article 297',0,0,NULL,NULL,NULL,NULL,'2025-10-18 15:10:53'),(54,297,9,NULL,NULL,'Mock comment 6 for article 297',0,0,NULL,NULL,NULL,NULL,'2025-12-13 08:31:02'),(55,297,13,NULL,NULL,'Mock comment 7 for article 297',0,0,NULL,NULL,NULL,NULL,'2026-02-08 06:39:56'),(56,297,17,NULL,NULL,'Mock comment 8 for article 297',0,0,NULL,NULL,NULL,NULL,'2026-02-10 11:18:30'),(57,297,13,NULL,NULL,'Mock comment 9 for article 297',0,0,NULL,NULL,NULL,NULL,'2026-03-03 09:37:18'),(58,297,16,NULL,NULL,'Mock comment 10 for article 297',0,0,NULL,NULL,NULL,NULL,'2026-03-05 10:12:40'),(59,297,2,NULL,NULL,'Mock comment 11 for article 297',0,0,NULL,NULL,NULL,NULL,'2026-03-06 03:32:06'),(60,297,18,NULL,NULL,'Mock comment 12 for article 297',0,0,NULL,NULL,NULL,NULL,'2026-03-06 09:00:22'),(61,297,19,NULL,NULL,'Mock comment 13 for article 297',0,0,NULL,NULL,NULL,NULL,'2026-03-20 12:17:12'),(62,298,18,NULL,NULL,'Mock comment 1 for article 298',0,0,NULL,NULL,NULL,NULL,'2025-12-28 00:42:13'),(63,298,20,NULL,NULL,'Mock comment 2 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-01-02 13:46:06'),(64,298,14,NULL,NULL,'Mock comment 3 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-01-05 01:39:18'),(65,298,4,NULL,NULL,'Mock comment 4 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-01-07 21:34:55'),(66,298,15,NULL,NULL,'Mock comment 5 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-01-18 20:53:03'),(67,298,5,NULL,NULL,'Mock comment 6 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-01-20 09:33:58'),(68,298,7,NULL,NULL,'Mock comment 7 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-01-21 06:53:14'),(69,298,5,NULL,NULL,'Mock comment 8 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-01-29 09:59:58'),(70,298,5,NULL,NULL,'Mock comment 9 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-02-09 21:51:40'),(71,298,2,NULL,NULL,'Mock comment 10 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-02-11 17:39:38'),(72,298,2,NULL,NULL,'Mock comment 11 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-02-26 15:06:17'),(73,298,11,NULL,NULL,'Mock comment 12 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-03-12 09:27:58'),(74,298,20,NULL,NULL,'Mock comment 13 for article 298',0,0,NULL,NULL,NULL,NULL,'2026-03-24 15:34:54'),(75,299,17,NULL,NULL,'Mock comment 1 for article 299',0,0,NULL,NULL,NULL,NULL,'2025-10-29 06:05:12'),(76,299,6,NULL,NULL,'Mock comment 2 for article 299',0,0,NULL,NULL,NULL,NULL,'2025-11-29 22:12:14'),(77,299,20,NULL,NULL,'Mock comment 3 for article 299',0,0,NULL,NULL,NULL,NULL,'2025-12-19 04:27:49'),(78,299,3,NULL,NULL,'Mock comment 4 for article 299',0,0,NULL,NULL,NULL,NULL,'2026-01-18 19:42:13'),(79,299,6,NULL,NULL,'Mock comment 5 for article 299',0,0,NULL,NULL,NULL,NULL,'2026-01-21 07:34:39'),(80,299,16,NULL,NULL,'Mock comment 6 for article 299',0,0,NULL,NULL,NULL,NULL,'2026-01-23 10:23:36'),(81,299,1,NULL,NULL,'Mock comment 7 for article 299',0,0,NULL,NULL,NULL,NULL,'2026-01-30 22:11:28'),(82,299,19,NULL,NULL,'Mock comment 8 for article 299',0,0,NULL,NULL,NULL,NULL,'2026-02-17 03:20:19'),(83,299,9,NULL,NULL,'Mock comment 9 for article 299',0,0,NULL,NULL,NULL,NULL,'2026-03-06 17:05:22'),(84,299,14,NULL,NULL,'Mock comment 10 for article 299',0,0,NULL,NULL,NULL,NULL,'2026-03-07 16:35:13'),(85,299,13,NULL,NULL,'Mock comment 11 for article 299',0,0,NULL,NULL,NULL,NULL,'2026-03-23 17:01:42'),(86,300,15,NULL,NULL,'Mock comment 1 for article 300',0,0,NULL,NULL,NULL,NULL,'2025-05-26 10:25:05'),(87,300,7,NULL,NULL,'Mock comment 2 for article 300',0,0,NULL,NULL,NULL,NULL,'2025-07-14 17:54:26'),(88,300,18,NULL,NULL,'Mock comment 3 for article 300',0,0,NULL,NULL,NULL,NULL,'2025-08-29 14:38:31'),(89,300,12,NULL,NULL,'Mock comment 4 for article 300',0,0,NULL,NULL,NULL,NULL,'2025-10-11 21:09:22'),(90,300,14,NULL,NULL,'Mock comment 5 for article 300',0,0,NULL,NULL,NULL,NULL,'2025-11-10 01:36:22'),(91,300,19,NULL,NULL,'Mock comment 6 for article 300',0,0,NULL,NULL,NULL,NULL,'2025-11-19 15:35:31'),(92,300,2,NULL,NULL,'Mock comment 7 for article 300',0,0,NULL,NULL,NULL,NULL,'2025-12-04 13:06:27'),(93,300,19,NULL,NULL,'Mock comment 8 for article 300',0,0,NULL,NULL,NULL,NULL,'2025-12-10 21:17:10'),(94,300,11,NULL,NULL,'Mock comment 9 for article 300',0,0,NULL,NULL,NULL,NULL,'2026-02-17 11:24:50'),(95,301,12,NULL,NULL,'Mock comment 1 for article 301',0,0,NULL,NULL,NULL,NULL,'2025-08-08 12:31:08'),(96,301,7,NULL,NULL,'Mock comment 2 for article 301',0,0,NULL,NULL,NULL,NULL,'2025-08-11 10:10:05'),(97,301,14,NULL,NULL,'Mock comment 3 for article 301',0,0,NULL,NULL,NULL,NULL,'2025-08-23 01:58:46'),(98,301,7,NULL,NULL,'Mock comment 4 for article 301',0,0,NULL,NULL,NULL,NULL,'2025-09-19 01:35:23'),(99,301,14,NULL,NULL,'Mock comment 5 for article 301',0,0,NULL,NULL,NULL,NULL,'2025-11-03 11:39:57'),(100,301,11,NULL,NULL,'Mock comment 6 for article 301',0,0,NULL,NULL,NULL,NULL,'2025-12-09 16:43:51'),(101,301,8,NULL,NULL,'Mock comment 7 for article 301',0,0,NULL,NULL,NULL,NULL,'2026-01-12 16:31:06'),(102,301,15,NULL,NULL,'Mock comment 8 for article 301',0,0,NULL,NULL,NULL,NULL,'2026-02-20 18:12:20'),(103,301,14,NULL,NULL,'Mock comment 9 for article 301',0,0,NULL,NULL,NULL,NULL,'2026-03-14 01:54:52'),(104,301,7,NULL,NULL,'Mock comment 10 for article 301',0,0,NULL,NULL,NULL,NULL,'2026-03-17 03:33:17'),(105,302,1,NULL,NULL,'Mock comment 1 for article 302',0,0,NULL,NULL,NULL,NULL,'2025-11-29 21:34:12'),(106,302,3,NULL,NULL,'Mock comment 2 for article 302',0,0,NULL,NULL,NULL,NULL,'2025-12-04 15:52:37'),(107,302,6,NULL,NULL,'Mock comment 3 for article 302',0,0,NULL,NULL,NULL,NULL,'2025-12-22 22:16:21'),(108,302,12,NULL,NULL,'Mock comment 4 for article 302',0,0,NULL,NULL,NULL,NULL,'2025-12-23 10:55:53'),(109,302,20,NULL,NULL,'Mock comment 5 for article 302',0,0,NULL,NULL,NULL,NULL,'2026-01-12 14:28:52'),(110,302,2,NULL,NULL,'Mock comment 6 for article 302',0,0,NULL,NULL,NULL,NULL,'2026-01-31 13:24:49'),(111,302,14,NULL,NULL,'Mock comment 7 for article 302',0,0,NULL,NULL,NULL,NULL,'2026-02-19 17:12:04'),(112,302,5,NULL,NULL,'Mock comment 8 for article 302',0,0,NULL,NULL,NULL,NULL,'2026-02-21 22:16:59'),(113,302,7,NULL,NULL,'Mock comment 9 for article 302',0,0,NULL,NULL,NULL,NULL,'2026-03-05 01:53:03'),(114,302,5,NULL,NULL,'Mock comment 10 for article 302',0,0,NULL,NULL,NULL,NULL,'2026-03-12 14:04:06'),(115,303,5,NULL,NULL,'Mock comment 1 for article 303',0,0,NULL,NULL,NULL,NULL,'2025-11-30 22:00:31'),(116,303,13,NULL,NULL,'Mock comment 2 for article 303',0,0,NULL,NULL,NULL,NULL,'2025-12-03 18:45:32'),(117,303,12,NULL,NULL,'Mock comment 3 for article 303',0,0,NULL,NULL,NULL,NULL,'2025-12-15 04:25:32'),(118,303,16,NULL,NULL,'Mock comment 4 for article 303',0,0,NULL,NULL,NULL,NULL,'2025-12-16 07:10:38'),(119,303,4,NULL,NULL,'Mock comment 5 for article 303',0,0,NULL,NULL,NULL,NULL,'2025-12-26 04:00:15'),(120,303,9,NULL,NULL,'Mock comment 6 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-01-02 15:12:54'),(121,303,8,NULL,NULL,'Mock comment 7 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-01-04 00:05:41'),(122,303,20,NULL,NULL,'Mock comment 8 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-01-12 05:26:37'),(123,303,13,NULL,NULL,'Mock comment 9 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-01-15 13:11:08'),(124,303,3,NULL,NULL,'Mock comment 10 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-01-22 10:09:15'),(125,303,6,NULL,NULL,'Mock comment 11 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-02-01 22:17:58'),(126,303,8,NULL,NULL,'Mock comment 12 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-02-06 14:17:54'),(127,303,18,NULL,NULL,'Mock comment 13 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-02-12 08:02:15'),(128,303,14,NULL,NULL,'Mock comment 14 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-02-24 21:01:23'),(129,303,9,NULL,NULL,'Mock comment 15 for article 303',0,0,NULL,NULL,NULL,NULL,'2026-03-06 16:17:21'),(130,304,16,NULL,NULL,'Mock comment 1 for article 304',0,0,NULL,NULL,NULL,NULL,'2025-08-29 16:37:05'),(131,304,6,NULL,NULL,'Mock comment 2 for article 304',0,0,NULL,NULL,NULL,NULL,'2025-09-03 19:25:49'),(132,304,16,NULL,NULL,'Mock comment 3 for article 304',0,0,NULL,NULL,NULL,NULL,'2025-09-14 00:26:05'),(133,304,11,NULL,NULL,'Mock comment 4 for article 304',0,0,NULL,NULL,NULL,NULL,'2025-09-14 21:16:12'),(134,304,9,NULL,NULL,'Mock comment 5 for article 304',0,0,NULL,NULL,NULL,NULL,'2025-09-25 15:03:32'),(135,304,4,NULL,NULL,'Mock comment 6 for article 304',0,0,NULL,NULL,NULL,NULL,'2025-10-18 10:38:10'),(136,304,4,NULL,NULL,'Mock comment 7 for article 304',0,0,NULL,NULL,NULL,NULL,'2025-11-27 21:56:14'),(137,304,13,NULL,NULL,'Mock comment 8 for article 304',0,0,NULL,NULL,NULL,NULL,'2025-12-26 16:43:32'),(138,304,17,NULL,NULL,'Mock comment 9 for article 304',0,0,NULL,NULL,NULL,NULL,'2026-03-03 01:31:49'),(139,305,7,NULL,NULL,'Mock comment 1 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-06-07 06:35:00'),(140,305,2,NULL,NULL,'Mock comment 2 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-06-13 04:42:56'),(141,305,16,NULL,NULL,'Mock comment 3 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-07-08 04:39:13'),(142,305,14,NULL,NULL,'Mock comment 4 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-07-22 09:07:29'),(143,305,20,NULL,NULL,'Mock comment 5 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-07-22 22:59:12'),(144,305,7,NULL,NULL,'Mock comment 6 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-08-20 08:23:42'),(145,305,1,NULL,NULL,'Mock comment 7 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-08-21 09:47:21'),(146,305,2,NULL,NULL,'Mock comment 8 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-08-21 23:06:38'),(147,305,3,NULL,NULL,'Mock comment 9 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-08-29 17:13:00'),(148,305,7,NULL,NULL,'Mock comment 10 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-10-23 17:34:19'),(149,305,9,NULL,NULL,'Mock comment 11 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-11-16 01:04:10'),(150,305,9,NULL,NULL,'Mock comment 12 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-11-27 06:53:10'),(151,305,1,NULL,NULL,'Mock comment 13 for article 305',0,0,NULL,NULL,NULL,NULL,'2025-12-27 07:21:55'),(152,305,7,NULL,NULL,'Mock comment 14 for article 305',0,0,NULL,NULL,NULL,NULL,'2026-02-19 13:56:42'),(153,305,17,NULL,NULL,'Mock comment 15 for article 305',0,0,NULL,NULL,NULL,NULL,'2026-02-28 06:19:00'),(154,306,5,NULL,NULL,'Mock comment 1 for article 306',0,0,NULL,NULL,NULL,NULL,'2025-05-13 17:31:08'),(155,306,9,NULL,NULL,'Mock comment 2 for article 306',0,0,NULL,NULL,NULL,NULL,'2025-06-20 22:59:38'),(156,306,12,NULL,NULL,'Mock comment 3 for article 306',0,0,NULL,NULL,NULL,NULL,'2025-07-10 12:06:44'),(157,306,9,NULL,NULL,'Mock comment 4 for article 306',0,0,NULL,NULL,NULL,NULL,'2025-07-24 06:02:02'),(158,306,7,NULL,NULL,'Mock comment 5 for article 306',0,0,NULL,NULL,NULL,NULL,'2025-08-28 08:37:27'),(159,306,8,NULL,NULL,'Mock comment 6 for article 306',0,0,NULL,NULL,NULL,NULL,'2025-09-25 20:56:11'),(160,306,13,NULL,NULL,'Mock comment 7 for article 306',0,0,NULL,NULL,NULL,NULL,'2025-12-04 16:36:27'),(161,306,14,NULL,NULL,'Mock comment 8 for article 306',0,0,NULL,NULL,NULL,NULL,'2026-03-17 04:49:10'),(163,296,2,NULL,NULL,'期待博主更新更多干货。',5,0,NULL,NULL,NULL,'上海','2026-03-26 14:42:02');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='定时任务调度表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_job` VALUES (1,'系统默认（无参）','DEFAULT','task.neatNoParams','* * * * * ? *','3','1','1','2024-11-17 12:39:45','2024-11-18 17:26:59',''),(2,'系统默认（有参）','DEFAULT','demoTask.ryParams(\'ry\')','0/15 * * * * ?','3','1','1','2024-11-17 12:39:45','2024-11-17 12:39:45',''),(3,'系统默认（多参）','DEFAULT','demoTask.ryMultipleParams(\'ry\', true, 2000L, 316.50D, 100)','0/20 * * * * ?','3','1','1','2024-11-17 12:39:45','2024-11-18 09:27:22','');
...
CREATE TABLE `sys_job_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='定时任务调度日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=147 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='权限资源表 ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_message` VALUES (1423,'游客',NULL,'西伯利亚','169.254.186.38','内网IP|内网IP',NULL,'2026-03-12 15:33:22',0);
...
INSERT INTO `sys_moment` VALUES (2,1,'<p>这一条用于测试</p>','','2026-03-27 17:15:50',0);
...
CREATE TABLE `sys_operate_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2249 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_photo` VALUES (2,1,'test-image-1.jpg','http://127.0.0.1:8800/localFile/test-image-1.jpg',NULL,NULL,NULL);
...
INSERT INTO `sys_role` VALUES (1,'admin','超级管理员','拥有一切权限\n','2024-11-16 12:29:00','2024-11-16 12:29:00'),(14,'demo','演示账号','仅提供演示用，所有按钮权限可看到但不能操作','2024-11-21 22:59:30','2024-11-21 22:59:29'),(15,'user','用户','门户注册的用户','2024-12-28 13:32:09','2024-12-28 13:32:08');
...
) ENGINE=InnoDB AUTO_INCREMENT=400 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='角色-权限资源关联表 ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role_menu` VALUES (394,1,141),(395,1,142),(396,1,143),(397,1,144),(398,1,145),(399,1,146),(28,2,1),(29,2,2),(25,2,4),(26,2,6),(27,2,7),(30,2,8),(370,14,1),(373,14,2),(374,14,3),(383,14,4),(380,14,13),(371,14,14),(384,14,16),(385,14,17),(387,14,18),(389,14,19),(391,14,30),(392,14,31),(377,14,32),(378,14,33),(393,14,34),(372,14,39),(381,14,51),(382,14,54),(379,14,55),(388,14,58),(390,14,66),(353,14,68),(358,14,69),(356,14,70),(354,14,71),(360,14,72),(361,14,74),(355,14,75),(359,14,80),(357,14,84),(362,14,88),(386,14,95),(365,14,96),(366,14,97),(367,14,98),(368,14,100),(369,14,101);
...
INSERT INTO `sys_slide` VALUES (1,'https://picsum.photos/1080/400?random=1','Welcome to Blog','/',1,1,'2026-03-27 22:03:17','2026-03-27 22:03:17'),(2,'https://picsum.photos/1080/400?random=2','Beautiful Scenery','/',2,1,'2026-03-27 22:03:17','2026-03-27 22:03:17'),(3,'https://picsum.photos/1080/400?random=3','Technology and Life','/',3,1,'2026-03-27 22:03:17','2026-03-27 22:03:17');
...
INSERT INTO `sys_tag` VALUES (1,'Spring Boot',20,'2021-11-12 14:43:27','2023-06-05 03:00:00'),(2,'Elasticsearch',6,'2021-11-12 14:43:27','2023-06-05 03:00:00'),(10,'博客',9,'2021-11-12 14:43:27','2023-06-05 03:00:00'),(12,'Vue',18,'2021-12-29 14:01:50','2023-06-05 03:00:00'),(13,'Spring Cloud',19,'2021-12-29 14:02:32','2023-06-05 03:00:00'),(17,'Redis',7,'2022-01-25 14:09:03','2023-06-05 03:00:00'),(18,'Linux',10,'2022-01-25 14:09:17','2023-06-05 03:00:00'),(31,'Mysql',10,'2022-02-18 16:01:07','2023-06-05 03:00:00'),(32,'Nginx',5,'2022-04-13 17:48:08','2023-06-05 03:00:00'),(51,'异步',5,'2023-04-03 11:30:54','2023-06-05 03:00:00'),(57,'Java Script',1,'2023-06-27 16:02:33','2023-06-27 08:02:32'),(59,'Dcoker',12,'2023-07-13 15:51:12','2023-07-13 07:51:12'),(60,'Aspect',0,'2023-07-25 17:07:19','2023-07-25 09:07:18'),(62,'oauth2',0,'2023-08-15 09:30:12','2023-08-15 01:30:11'),(63,'服务器',0,'2023-09-05 17:28:08','2023-09-05 09:28:07'),(65,'Css',0,'2023-09-25 11:19:00','2023-09-25 03:18:59'),(66,'Java',11,'2023-10-07 09:28:50','2023-10-07 01:28:50'),(67,'Juc',12,'2023-10-07 09:28:55','2023-10-07 01:28:54'),(69,'高并发',14,'2023-10-07 09:29:11','2023-10-07 01:29:11'),(70,'资源',0,'2023-10-12 10:46:35','2023-10-12 02:46:34'),(71,'websoket',0,'2023-12-14 17:17:58','2023-12-14 09:17:58'),(72,'uniapp',0,'2023-12-26 11:28:20','2023-12-26 03:28:20'),(73,'宝塔',0,'2024-02-19 16:17:29','2024-02-19 08:17:29'),(89,'vite',0,'2024-04-12 11:49:23','2024-04-12 11:49:22'),(90,'electron',0,'2024-04-17 16:08:46','2024-04-17 16:08:46'),(100,'Vue.js',0,'2026-03-12 15:08:50','2026-03-12 15:08:50'),(101,'Docker',0,'2026-03-12 15:08:50','2026-03-12 15:08:50');
...
) ENGINE=InnoDB AUTO_INCREMENT=1814 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='用户信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,'admin','$2a$10$GSHv.XwqBkizplz5j2pcmu73IRY2rgtxCYQwAvSXMvu9SryzydLpe','2024-12-27 14:16:17','2024-12-30 13:43:25',1,'127.0.0.1','内网IP|内网IP','Windows','2026-03-29 20:51:23','Chrome','管理员','/avatar/blogger.jpg','',NULL,1,'email',NULL),(1811,'rush','\\.FGdrbTOKqsVvkOL94gdEJgmqM.','2026-03-25 13:52:11','2026-03-25 13:52:11',1,NULL,NULL,NULL,'2026-03-25 13:52:11',NULL,'管理员','/avatar/blogger.jpg',NULL,NULL,NULL,NULL,NULL),(1812,'testuser1','\\.XwqBkizplz5j2pcmu73IRY2rgtxCYQwAvSXMvu9SryzydLpe','2023-01-01 10:00:00','2026-03-29 13:05:18',1,NULL,NULL,NULL,'2026-03-29 13:05:18',NULL,'测试用户一',NULL,NULL,NULL,NULL,'email',NULL),(1813,'testuser2','\\.XwqBkizplz5j2pcmu73IRY2rgtxCYQwAvSXMvu9SryzydLpe','2024-02-15 08:30:00','2026-03-29 13:05:30',1,NULL,NULL,NULL,'2026-03-29 13:05:30',NULL,'测试用户二',NULL,NULL,NULL,NULL,'email',NULL);
...
CREATE TABLE `sys_user_article_history` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_user_article` (`user_id`,`article_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='鐢ㄦ埛娴忚?鍘嗗彶琛';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_article_history` VALUES (1,1,292,'2026-03-29 20:45:59','2026-03-29 20:49:58');
...
CREATE TABLE `sys_user_role` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='系统管理 - 用户角色关联表 ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_role` VALUES (1,1,1),(42,14,9),(44,14,1810),(45,1,1811);
...
-- Dump completed on 2026-04-13 10:49:48
